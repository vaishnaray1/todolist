...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post interactions_url, params: { interaction: { item_id: @interaction.item_id, user_id: @interaction.user_id } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { item_id: @interaction.item_id, user_id: @interaction.user_id } }
